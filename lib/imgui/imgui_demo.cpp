...
void ImGui::ShowDemoWindow(bool* p_open)
{
    ...
    // We specify a default position/size in case there's no data in the .json file. Typically this isn't required! We only do it to make the Demo applications a little more welcoming.
