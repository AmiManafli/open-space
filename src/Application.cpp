...
void Application::init() {
    ...
    meshShaderProgram->attachShader("C:\\Users\\amina\\Documents\\Projects\\ComputerGraphics\\cg1-project\\Debug\\mesh.vert", ShaderType::VertexShader);
    meshShaderProgram->attachShader("C:\\Users\\amina\\Documents\\Projects\\ComputerGraphics\\cg1-project\\Debug\\mesh.frag", ShaderType::FragmentShader);
    meshShaderProgram->link();

    gridShaderProgram = new ShaderProgram();
    gridShaderProgram->attachShader("C:\\Users\\amina\\Documents\\Projects\\ComputerGraphics\\cg1-project\\Debug\\grid.vert", ShaderType::VertexShader);
    gridShaderProgram->attachShader("C:\\Users\\amina\\Documents\\Projects\\ComputerGraphics\\cg1-project\\Debug\\grid.frag", ShaderType::FragmentShader);
    gridShaderProgram->link();

    highlightShaderProgram = new ShaderProgram();
    highlightShaderProgram->attachShader("C:\\Users\\amina\\Documents\\Projects\\ComputerGraphics\\cg1-project\\Debug\\mesh.vert", ShaderType::VertexShader);
    highlightShaderProgram->attachShader("C:\\Users\\amina\\Documents\\Projects\\ComputerGraphics\\cg1-project\\Debug\\highlight.frag", ShaderType::FragmentShader);
    ...
    createModel("C:\\Users\\amina\\Documents\\Projects\\ComputerGraphics\\cg1-project\\Debug\\ico-sphere.dae", glm::vec3(0, 0, 0), meshShaderProgram, false);
}
